...
class ProductMedia(Base):
    ...
    __table_args__ = (
        sa.Index("uix_product_media_product_media_variant_not_null", "product_id", "media_id", "variant_id", unique=True, postgresql_where=sa.text("variant_id IS NOT NULL"),),
        sa.Index("uix_product_media_product_media_variant_null", "product_id", "media_id", unique=True, postgresql_where=sa.text("variant_id IS NULL"),),
        sa.Index("uix_product_primary_image", "product_id", unique=True, postgresql_where=sa.text("is_primary = true"),),
    )
